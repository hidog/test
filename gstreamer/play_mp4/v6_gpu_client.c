...
int main( int argc, char *argv[] )
{
    ...
    //
    gst_bin_add_many( GST_BIN(data.pipeline), data.src, data.enc, data.pay, data.sink, NULL );

    //
    gst_element_link_filtered( data.src, data.enc, caps );
    gst_element_link_many( data.enc, data.pay, data.sink, NULL );
