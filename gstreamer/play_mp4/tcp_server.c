...
int main( int argc, char *argv[] ) 
{
    ...
    data.source        = gst_element_factory_make( "tcpserversrc", "source" );
    g_object_set( G_OBJECT(data.source), "host", "127.0.0.1",NULL);
    g_object_set( G_OBJECT(data.source), "port", 3000 ,NULL);
