...
ImagePaint::ImagePaint() : QGraphicsItem() , QGraphicsSvgItem()
{
    //image = imagePass;
    //total = image.rect();
...
// Constructor
//ImagePaint::ImagePaint(QImage imagePass, QObject *parent) : QObject(parent)
ImagePaint::ImagePaint(QImage imagePass) : QGraphicsItem() , QGraphicsSvgItem()
{
    image = imagePass;
    total = image.rect();
    viewRect = QRectF(total);
...
// Constructor
//ImagePaint::ImagePaint(QImage imagePass, QObject *parent) : QObject(parent)
ImagePaint::ImagePaint(QString name) : QGraphicsItem() , QGraphicsSvgItem(name)
{
    //image = imagePass;
    //total = image.rect();
    //viewRect = QRectF(total);
...
/*void	ImagePaint::setGraphicsEffect(QGraphicsEffect *effect)
{
