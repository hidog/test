...
typedef boost::numeric::ublas::vector<float> bVectorFloat;
...
void icvGetRectSubPix_8u32f_C1R( const uchar* src, int src_step, CvSize src_size,  float* dst, int dst_step, CvSize win_size, CvPoint2D32f center );
void cvFindCornerSubPix2( const void* srcarr, CvPoint2D32f* corners,  int count, CvSize win, CvSize zeroZone );
